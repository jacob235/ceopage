        ...
        <Table >   
          ...
          <TableBody>            
              {this.state.QNAS ? this.state.QNAS.map(c => {
                return (    
                  <QNAS stateRefresh={this.stateRefresh} key={c.QnA_id}  QnA_title={c.QnA_title} user_id={c.user_id} QnA_content={c.QnA_content} QnA_date={c.QnA_date} order={c.order}/>
                 )}) : "no data"}
          </TableBody>
        </Table>
